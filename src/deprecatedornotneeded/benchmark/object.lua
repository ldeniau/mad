...
do
    ...
    stop = os.clock()
    print("7th level, 3 elements only last level, table created outside of loop not using set")
    print("  Average speed: "..tostring(n/(stop-start)).." objects per second")
end
...
do
    ...
    local obj7 = obj6 "obj7"
    local obj8, start, stop
local dummy1, dummy2, dummy3 = 0
    obj8 = obj7 "obj8"
    start = os.clock()
    for i = 1, n do
        dummy1 = obj8:get{"two","two2","two22"}
    end
    stop = os.clock()
    print("Dummy = ", dummy1)
