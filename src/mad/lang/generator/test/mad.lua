...
function test:lambda_noarg(ut)
    ...
    generator:render{ ast_id = "fundef", kind = "lambda", param = {}, block = { ast_id = "block_stmt", { ast_id = "ret_stmt", { ast_id = "literal", value = "1" } } } }
    ut:equals(tostring(generator.writer), [[\ 1]])
end

function test:lambda(ut)
    self.mod:render{ ast_id = "fundef", kind = "lambda", param = { { ast_id = "name", name = "a" }, { ast_id = "name", name = "b" } }, block = { ast_id = "block_stmt", { ast_id = "ret_stmt", { ast_id = "literal", value = "1" } } } }
    ut:equals(tostring(self.mod.writer), [[\a,b 1]])
end
