...
SYNOPSIS
  local actionsInteractiveError = require"mad.lang.parser.actions.interactiveError".actions

DESCRIPTION
  Error handling for ast-building when working in interactive mode
