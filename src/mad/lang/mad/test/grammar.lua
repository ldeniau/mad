...
function M:lambda(ut)
    local grammar = "rule <- lambda? s (!./''=>error)\n" .. self.grammar
    local parser = ut:succeeds(self.compile, grammar, self.defs)
    local res = ut:succeeds(parser.match, parser, [[\a 1]])
    ut:equals(res.kind, "lambda")
    ut:equals(res.ast_id, "fundef")
    ut:equals(res.param[1].name, "a")
    ut:equals(res.block.ast_id, "block_stmt")
    ut:equals(res.block[1].ast_id, "ret_stmt")
    ...
    ut:equals(res.kind, "lambda")
    ut:equals(res.ast_id, "fundef")
    ut:equals(res.param[1], nil)
    ut:equals(res.block.ast_id, "block_stmt")
    ut:equals(res.block[1].ast_id, "ret_stmt")
    ut:equals(res.block[1][1].value, "1")
    res = ut:succeeds(parser.match, parser, [[\ (1,2)]])
    ut:equals(res.kind, "lambda")
    ut:equals(res.ast_id, "fundef")
    ut:equals(res.param[1], nil)
    ut:equals(res.block.ast_id, "block_stmt")
